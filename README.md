...
- **Hand Tracking** - camera-based [ASL gesture control](GESTURES.md) using [MediaPipe](https://ai.google.dev/edge/mediapipe/solutions/guide) hand landmarks with a pure-Kotlin rule-based classifier, two interaction modes (ASL sign selection and conductor orchestration), and real-time camera overlay with hand skeleton visualization
