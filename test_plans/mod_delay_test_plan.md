...
The Mod Delay system features dual independent delay lines with multiple modulation sources (LFO or self-modulation), providing chorus, flanger, and tape delay effects.
