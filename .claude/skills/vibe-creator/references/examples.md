...
| Static / loop-based | `progressionAnchor = ProgressionAnchor.EVERY_8`, `progressionDriftRange = 0.08f`, `customProgression = listOf(0, 0, 5, 6, 0, 0, 3, 6)` | Anchor every 8 bars; minimal drift; explicit progression holds on tonic then steps. |
...
- **customProgression uses 0-indexed scale degrees**: `listOf(0, 0, 5, 6, 0, 0, 3, 6)` means I-I-vi-VII-I-I-iv-VII in the minor scale. (Scale degrees: 0=I, 1=ii, 2=iii, 3=iv, 4=v, 5=VI, 6=VII.)
