...
- Production build: `./gradlew :apps:orpheus:webApp:wasmJsBrowserDistribution`
- Dev server: `./gradlew :apps:orpheus:webApp:wasmJsBrowserDevelopmentRun` (serves on localhost:8080)
...
- All JS bridge files live in `apps/orpheus/webApp/src/wasmJsMain/resources/`
