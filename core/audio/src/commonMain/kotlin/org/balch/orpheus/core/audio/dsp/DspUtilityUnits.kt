...
private inline val UTIL_SAMPLE_RATE get() = dspSampleRate
private const val BAKE_SIZE = 1024

/**
 * Kotlin-native utility DSP units.
 ...
 */
class DspClockUnit : ClockUnit, DspProcessable {
    @Volatile override var enabled = true
    private val freq = DspAudioInput("Clock.freq")
    private val pw = DspAudioInput("Clock.pulseWidth")
    private val out = DspAudioOutput("Clock.out")
 ...
 */
class DspAutomationPlayer : AutomationPlayer, DspProcessable {
    @Volatile override var enabled = true
    private val out = DspAudioOutput("Automation.out")
    override val output: AudioOutput = out
