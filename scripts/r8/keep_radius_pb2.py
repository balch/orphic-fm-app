"""Protobuf bindings for R8 Configuration Analyzer output.

Generated descriptor for the BlastRadiusContainer proto used by R8 9.3.7-dev+
when the JVM property -Dcom.android.tools.r8.dumpkeepradiustodirectory is set.

Source: skills/performance/r8-analyzer/references/CONFIGURATION-ANALYZER.md
"""
