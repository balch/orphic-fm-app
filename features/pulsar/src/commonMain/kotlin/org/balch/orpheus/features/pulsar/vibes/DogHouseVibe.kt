    ...
    val sectionList by lazy {
        listOf(
            ...
            Section(
                ...
                transitions = listOf(
                    SectionTransition(
                        targetIndex = 2,
                        weight = 0.7f,
                        transitionBars = bigBluesLiftBars
                    ),
                    SectionTransition(
                        targetIndex = 1,
                        weight = 0.3f,
            ...
            Section(
                name = "outro",
                barsMin = 4, barsMax = 4,
                macroOverrides = MacroOverrides(energy = 1.5f, complexity = 0.4f, space = 0.5f),
                customProgression = chorusProgression,
                chordsPerBar = chorusChordsPerBar,
            ),
        )
