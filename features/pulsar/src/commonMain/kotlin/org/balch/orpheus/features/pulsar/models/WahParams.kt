 ...
 * (orpheus_wah_core.h) field-for-field. Powers two consumers: the wah anomaly ([org.balch.orpheus.features.pulsar.anonmalies.WahAnomaly],
 * swept over its armed duration, marshaled into the `wah_data_*` bank) and the per-track
 * lick-wah insert (`Vibe.lickWah` / `TrackRole.Melodic.wahLick`).
 *
