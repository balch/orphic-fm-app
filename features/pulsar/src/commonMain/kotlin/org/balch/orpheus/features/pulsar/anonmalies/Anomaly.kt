...
/**
 * A rare, dramatic event dispatched by the Anomaly Engine. A [org.balch.orpheus.features.pulsar.models.Vibe] declares zero or more
 * anomalies in [org.balch.orpheus.features.pulsar.models.Vibe.anomalies]; each concrete type has its own probability and fires on its
 * own terms:
 ...
 *   declared anomalies at once. A vibe with an empty [org.balch.orpheus.features.pulsar.models.Vibe.anomalies] list ignores the trigger.
 *
 ...
 * lick-anomaly slot in the lick bank), which is why [org.balch.orpheus.features.pulsar.models.Vibe.init] caps each type at one.
 *
