...
/**
 * Config for the Crossfade Anomaly — a rare "the whole mix dips and returns" moment on the
 ...
 * declares it (the crossfade only arms while a section graph is active, which also gates the
 * live trigger).
 *
