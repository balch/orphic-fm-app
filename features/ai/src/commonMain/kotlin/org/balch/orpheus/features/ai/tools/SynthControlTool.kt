...
class SynthControlTool(
    ...
    override val tool by lazy {
        object : Tool<SynthControlArgs, SynthControlResult>(
            ...
            private val controls get() = featureCollection.allFeatures.map { it.synthControl }
             ...
             */
            private val controlLookup: Map<String, PluginControlId> by lazy {
                buildMap {
            ...
            private suspend fun executeInternal(args: SynthControlArgs): SynthControlResult {
                ...
                if (targetId.symbol.startsWith("duo_engine") || (targetId.symbol.startsWith("duo_mod_source") && !targetId.symbol.startsWith(
                    ...
                    return SynthControlResult(
                        success = true,
                        message = "Set ${shortKey(targetId)} to $intValue"
                    )
                }
            ...
            companion object {
                ...
                private fun buildToolDescription(features: Collection<SynthFeature<*, *>>): String {
                    ...
                    val sections = sortedFeatures.joinToString("\n\n") { feature ->
                        ...
                        val keys =
                            ctrl.portControlKeys.entries.joinToString("\n") { (fullKey, desc) ->
