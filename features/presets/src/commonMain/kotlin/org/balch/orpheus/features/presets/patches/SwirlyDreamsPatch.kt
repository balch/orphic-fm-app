...
class SwirlyDreamsPatch : SynthPatch {
    ...
    override val preset = SynthPreset(
        ...
        portValues = buildMap {
            ...
            // Duo morph — heavy detune for swirly chorus-like detuning
            val duoMorphs = listOf(0.40f, 0.35f, 0.45f, 0.30f)
            duoMorphs.forEachIndexed { i, v -> put("org.balch.orpheus.plugins.voice:duo_morph_$i", PortValue.FloatValue(v)) }

            // Duo mod depth — deep LFO-driven timbre modulation
            val duoModSourceLevels = listOf(0.55f, 0.50f, 0.55f, 0.50f)
