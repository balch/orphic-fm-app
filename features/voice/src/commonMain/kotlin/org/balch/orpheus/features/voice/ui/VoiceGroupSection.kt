    ...
    Column(
        ...
        Row(
            ...
            DuoVoiceBox(
                ...
                sharpness = voiceState.duoSharpness[voiceStartIndex / 2],
                ...
                duoEngine = voiceState.duoEngines[voiceStartIndex / 2],
                duoHarmonics = voiceState.duoHarmonics[voiceStartIndex / 2],
                duoMorph = voiceState.duoMorphs[voiceStartIndex / 2],
                duoModSourceLevel = voiceState.duoModSourceLevels[voiceStartIndex / 2],
                midiState = midiState,
                voiceActions = voiceActions,
                midiActions = midiActions,
            ...
            DuoVoiceBox(
                ...
                sharpness = voiceState.duoSharpness[(voiceStartIndex + 2) / 2],
                ...
                duoEngine = voiceState.duoEngines[(voiceStartIndex + 2) / 2],
                duoHarmonics = voiceState.duoHarmonics[(voiceStartIndex + 2) / 2],
                duoMorph = voiceState.duoMorphs[(voiceStartIndex + 2) / 2],
                duoModSourceLevel = voiceState.duoModSourceLevels[(voiceStartIndex + 2) / 2],
                midiState = midiState,
                voiceActions = voiceActions,
                midiActions = midiActions,
                isVoiceBeingLearned = isVoiceBeingLearned,
