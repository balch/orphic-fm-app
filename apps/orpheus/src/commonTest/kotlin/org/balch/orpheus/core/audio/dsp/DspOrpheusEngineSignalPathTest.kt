...
/**
 * Signal Path Documentation Tests for DspOrpheusEngine.
 *
 * These tests validate that the documented routing rules in DspOrpheusEngine.kt
 ...
 * scan the DspOrpheusEngine source for routing violations.
 *
 ...
 */
class DspOrpheusEngineSignalPathTest {

    // The init block source code as a string for pattern matching
    // This is extracted from DspOrpheusEngine.kt and validated against rules
...
/**
 * NOTE: Full source code validation would require reading DspOrpheusEngine.kt
 * at test time, which isn't practical in KMP common tests.
 * 
 * The primary value here is:
 * 1. The ARCHITECTURE documentation in DspOrpheusEngine.kt header
